...
c$$$      PARAMETER ( MXCLY = 70, MXULV = 5, MXCMU = 48, MXUMU = 12,
c$$$     &          MXPHI = 6, MI = MXCMU / 2, MI9M2 = 9*MI - 2,
c$$$     &          NNLYRI = MXCMU*MXCLY, MXSQT = 1000 )

c$$$      PARAMETER ( MXCLY = 35, MXULV = 2, MXCMU = 32, MXUMU = 8,
c$$$     &          MXPHI = 7, MI = MXCMU / 2, MI9M2 = 9*MI - 2,
c$$$     &          NNLYRI = MXCMU*MXCLY, MXSQT = 1000 )

      PARAMETER ( MXCLY = 20, MXULV = 15, MXCMU = 48, MXUMU = 100,
     &          MXPHI = 180, MI = MXCMU / 2, MI9M2 = 9*MI - 2,
     &          NNLYRI = MXCMU*MXCLY, MXSQT = 1000 )

c$$$          PARAMETER ( MXCLY = 2, MXULV = 2, MXCMU = 64, MXUMU = 32,
c$$$     &          MXPHI = 64, MI = MXCMU / 2, MI9M2 = 9*MI - 2,
c$$$     &          NNLYRI = MXCMU*MXCLY, MXSQT = 1000 )
...
c                       ** Loop over angle of reflection
   ...
   30 CONTINUE
      ...
      IF(DREF.LT.0) THEN
        PRINT *, "DREF is set to 0!!", DREF, "VZA", ACOS(MU)*180./PI
        DREF=0.
      ENDIF
